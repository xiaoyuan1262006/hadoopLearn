...
import com.gwmfc.lxy.learn.hdfs.entityBean.WordCountCombiner;
...
public class JobSubmitterLocal {
    public static void main(String[] args) throws Exception{
       ...
       // configuration.set();
        ...
        FileInputFormat.setInputPaths(job,new Path("G:\\bigdata\\wordcountinput"));
        FileOutputFormat.setOutputPath(job,new Path("G:\\bigdata\\wordcountoutput"));
