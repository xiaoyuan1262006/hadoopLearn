...
public class ApplicationTest {
    ...
    public void testDelete()throws Exception{
        ...
        fileSystem.delete(new Path("user/mkdir/input/yy.jpg"),true);
        fileSystem.close();
    }
    ...
    public void TestWritFile() throws Exception{
        ...
        FSDataOutputStream fo =  fileSystem.create(new Path("/user/mkdir/input/ceshi1.png"));
        FileInputStream fis = new FileInputStream("G:\\ceshi.png");
        byte[] buf = new byte[1024];
        int read = 0;
